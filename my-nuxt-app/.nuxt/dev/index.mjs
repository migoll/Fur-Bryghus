...
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/h3/dist/index.mjs";
import {
  createRenderer,
  getRequestDependencies,
  getPreloadLinks,
  getPrefetchLinks,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/vue-bundle-renderer/dist/runtime.mjs";
...
import {
  ...
  withTrailingSlash,
  joinRelativeURL,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/ufo/dist/index.mjs";
import {
  createHead as createHead$1,
  propsToString,
  renderSSRHead,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/unhead/dist/server.mjs";
import {
  isVNode,
  toValue,
  isRef,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/vue/index.mjs";
...
import defu, {
  defuFn,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/defu/dist/defu.mjs";
...
import {
  stringify,
  uneval,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/devalue/index.js";
import {
  DeprecationsPlugin,
  PromisesPlugin,
  TemplateParamsPlugin,
  AliasSortingPlugin,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/unhead/dist/plugins.mjs";
...
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/ofetch/dist/node.mjs";
import {
  fetchNodeRequestHandler,
  callNodeRequestHandler,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/node-mock-http/dist/index.mjs";
import {
  createStorage,
  prefixStorage,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/unstorage/dist/index.mjs";
...
import {
  toRouteMatcher,
  createRouter,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/radix3/dist/index.mjs";
import { readFile } from "node:fs/promises";
import consola, {
  consola as consola$1,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/consola/dist/index.mjs";
...
import {
  ...
  parseRawStackTrace,
} from "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/node_modules/errx/dist/index.js";

const serverAssets = [
  {
    baseName: "server",
    dir: "C:/Users/Black Mold/OneDrive - Professionshøjskolen UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/src/server/assets",
  },
];
...
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: true,
    base: "C:/Users/Black Mold/OneDrive - Professionshøjskolen UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app",
...
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: true,
    base: "C:/Users/Black Mold/OneDrive - Professionshøjskolen UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/src/server",
    watchOptions: { ignored: [null] },
  })
);
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "C:/Users/Black Mold/OneDrive - Professionshøjskolen UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/.nuxt",
  })
);
storage.mount(
  "cache",
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "C:/Users/Black Mold/OneDrive - Professionshøjskolen UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/.nuxt/cache",
  })
);
storage.mount(
  "data",
  unstorage_47drivers_47fs({
    driver: "fs",
    base: "C:/Users/Black Mold/OneDrive - Professionshøjskolen UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/.data/kv",
  })
);
...
const errorHandler$0 = async function errorhandler(
  error,
  event,
  { defaultHandler }
) {
  ...
  if (
    typeof defaultRes.body !== "string" &&
    Array.isArray(defaultRes.body.stack)
  ) {
...
function fmtFrame(frame) {
  ...
  const src = `${frame.fileName || ""}:${frame.lineNumber}:${
    frame.columnNumber
  })`;
...
const rootDir =
  "C:/Users/Black Mold/OneDrive - Professionshøjskolen UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app";
...
const devReducers = {
  VNode: (data) =>
    isVNode(data) ? { type: data.type, props: data.props } : void 0,
  ...
  nitroApp.hooks.hook("render:html", (htmlContext) => {
    ...
    try {
      const reducers = Object.assign(
        ...
        devReducers,
        ctx.event.context._payloadReducers
      );
      htmlContext.bodyAppend.unshift(
        `<script type="application/json" data-nuxt-logs="${appId}">${stringify(
          ctx.logs,
          reducers
        )}<\/script>`
      );
...
function getSocketAddress() {
  const socketName = `nitro-worker-${
    process.pid
  }-${threadId}-${NITRO_DEV_WORKER_ID}-${Math.round(Math.random() * 1e4)}.sock`;
...
const template$1 = (messages) => {
  ...
  return (
    ...
    messages.statusCode +
    " - " +
    (messages.statusMessage || "Internal Server Error") +
    ...
    messages.statusCode +
    '</h1><p class="font-light leading-tight mb-8 sm:text-2xl text-xl">' +
    messages.description +
    '</p><div class="bg-black/5 bg-white dark:bg-white/10 flex-1 h-auto overflow-y-auto rounded-t-md"><div class="font-light leading-tight p-8 text-xl z-10">' +
    messages.stack +
    "</div></div></body></html>"
  );
};
...
const getClientManifest = () =>
  import(
    "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/.nuxt/dist/server/client.manifest.mjs"
  )
    .then((r) => r.default || r)
    .then((r) => (typeof r === "function" ? r() : r));
const getServerEntry = () =>
  import(
    "file://C:/Users/Black%20Mold/OneDrive%20-%20Professionsh%C3%B8jskolen%20UCN/Documents/GitHub/Fur-Bryghus/my-nuxt-app/.nuxt/dist/server/server.mjs"
  ).then((r) => r.default || r);
...
async function getIslandContext(event) {
  ...
  const context =
    event.method === "GET" ? getQuery$1(event) : await readBody(event);
  const ctx = {
    url: "/",
    ...context,
    id: hashId,
...
const renderer = defineRenderHandler(async (event) => {
  ...
  const inlinedStyles = isRenderingIsland
        ...
        link: [
          {
            ...
            href: buildAssetsURL(
              `builds/meta/${ssrContext.runtimeConfig.app.buildId}.json`
            ),
          },
        ],
      },
  ...
  }
  {
    ...
    for (const resource of Object.values(styles)) {
      ...
      if (
        !isRenderingIsland ||
        (resource.file.includes("scoped") && !resource.file.includes("pages/"))
      ) {
        link.push({
          rel: "stylesheet",
  ...
  if (isRenderingIsland && islandContext) {
    ...
    for (const entry of head.entries.values()) {
      for (const [key, value] of Object.entries(
        resolveUnrefHeadInput(entry.input)
      )) {
...
function getClientIslandResponse(ssrContext) {
  ...
  for (const [clientUid, component] of Object.entries(
    ssrContext.islandContext.components
  )) {
    const html =
      ssrContext.teleports?.[clientUid]?.replaceAll(
...
function replaceIslandTeleports(ssrContext, html) {
  ...
  for (const key in teleports) {
    ...
    if (matchClientComp) {
      ...
      html = html.replace(
        new RegExp(
          ` data-island-uid="${uid}" data-island-component="${clientId}"[^>]*>`
        ),
        (full) => {
